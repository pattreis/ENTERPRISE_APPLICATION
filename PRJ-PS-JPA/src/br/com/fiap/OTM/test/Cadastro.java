...
public class Cadastro {
	public static void main(String[] args) throws CommitException {
		...
		// SEM Cascade
		/*
		 * LivroDAO dao = new LivroDAOImpl(em); AutorDAO daoAutor = new
		 * AutorDAOImpl(em);
		 * 
		 * Autor autor = new Autor(); autor.setNome("J.R.R. Tolken");
		 * 
		 * Livro livro = new Livro(); livro.setAutor(autor);
		 * livro.setTitulo("O Senhor dos Anéis"); livro.setLancamento(new
		 * GregorianCalendar(1954, Calendar.JULY, 29));
		 * 
		 * dao.inserir(autor); dao.inserir(livro); dao.commit();
		 */
